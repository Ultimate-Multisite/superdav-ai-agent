...
class KnowledgeDatabaseTest extends WP_UnitTestCase {
	...
	public function test_collections_table_name(): void {
		global $wpdb;
		$expected = $wpdb->prefix . 'gratis_ai_agent_knowledge_collections';
	...
	public function test_sources_table_name(): void {
		global $wpdb;
		$expected = $wpdb->prefix . 'gratis_ai_agent_knowledge_sources';
	...
	public function test_chunks_table_name(): void {
		global $wpdb;
		$expected = $wpdb->prefix . 'gratis_ai_agent_knowledge_chunks';
	...
	public function test_get_schema_contains_all_tables(): void {
		...
		$this->assertStringContainsString( 'gratis_ai_agent_knowledge_collections', $schema );
		$this->assertStringContainsString( 'gratis_ai_agent_knowledge_sources', $schema );
		$this->assertStringContainsString( 'gratis_ai_agent_knowledge_chunks', $schema );
	}
