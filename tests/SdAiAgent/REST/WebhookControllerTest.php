...
class WebhookControllerTest extends WP_UnitTestCase {
	...
	public function test_routes_are_registered(): void {
		...
		$expected = [
			'/sd-ai-agent/v1/webhook/trigger',
			'/sd-ai-agent/v1/webhooks',
			'/sd-ai-agent/v1/webhooks/(?P<id>\d+)',
			'/sd-ai-agent/v1/webhooks/(?P<id>\d+)/logs',
			'/sd-ai-agent/v1/webhooks/(?P<id>\d+)/rotate-secret',
		];
	...
	public function test_webhooks_requires_auth(): void {
		...
		$response = $this->dispatch( 'GET', '/sd-ai-agent/v1/webhooks' );
	...
	public function test_create_webhook_requires_name(): void {
		wp_set_current_user( $this->admin_id );
		$response = $this->dispatch( 'POST', '/sd-ai-agent/v1/webhooks', [] );
	...
	public function test_get_webhook_not_found(): void {
		wp_set_current_user( $this->admin_id );
		$response = $this->dispatch( 'GET', '/sd-ai-agent/v1/webhooks/999999' );
	...
	public function test_get_webhook_returns_200(): void {
		...
		$response = $this->dispatch( 'GET', "/sd-ai-agent/v1/webhooks/{$webhook['id']}" );
		$this->assertStatus( 200, $response );
	...
	public function test_get_webhook_requires_auth(): void {
		wp_set_current_user( 0 );
		$response = $this->dispatch( 'GET', '/sd-ai-agent/v1/webhooks/1' );
		$this->assertStatus( 401, $response );
	}
	...
	public function test_update_webhook_not_found(): void {
		wp_set_current_user( $this->admin_id );
		$request = new WP_REST_Request( 'PATCH', '/sd-ai-agent/v1/webhooks/999999' );
	...
	public function test_update_webhook_no_fields_returns_400(): void {
		...
		$request = new WP_REST_Request( 'PATCH', "/sd-ai-agent/v1/webhooks/{$webhook['id']}" );
	...
	public function test_delete_webhook_not_found(): void {
		wp_set_current_user( $this->admin_id );
		$request  = new WP_REST_Request( 'DELETE', '/sd-ai-agent/v1/webhooks/999999' );
		$response = $this->server->dispatch( $request );
		$this->assertStatus( 404, $response );
	}
	...
	public function test_delete_webhook_returns_200(): void {
		...
		$request  = new WP_REST_Request( 'DELETE', "/sd-ai-agent/v1/webhooks/{$webhook['id']}" );
		$response = $this->server->dispatch( $request );
	...
	public function test_delete_webhook_requires_auth(): void {
		wp_set_current_user( 0 );
		$request  = new WP_REST_Request( 'DELETE', '/sd-ai-agent/v1/webhooks/1' );
		$response = $this->server->dispatch( $request );
		$this->assertStatus( 401, $response );
	}
	...
	public function test_logs_not_found(): void {
		wp_set_current_user( $this->admin_id );
		$response = $this->dispatch( 'GET', '/sd-ai-agent/v1/webhooks/999999/logs' );
		$this->assertStatus( 404, $response );
	}
	...
	public function test_logs_returns_200_with_structure(): void {
		...
		$response = $this->dispatch( 'GET', "/sd-ai-agent/v1/webhooks/{$webhook['id']}/logs" );
		$this->assertStatus( 200, $response );
	...
	public function test_logs_requires_auth(): void {
		wp_set_current_user( 0 );
		$response = $this->dispatch( 'GET', '/sd-ai-agent/v1/webhooks/1/logs' );
		$this->assertStatus( 401, $response );
	}
	...
	public function test_rotate_secret_not_found(): void {
		wp_set_current_user( $this->admin_id );
		$response = $this->dispatch( 'POST', '/sd-ai-agent/v1/webhooks/999999/rotate-secret', [] );
		$this->assertStatus( 404, $response );
	}
	...
	public function test_rotate_secret_returns_new_secret(): void {
		...
		$response = $this->dispatch( 'POST', "/sd-ai-agent/v1/webhooks/{$webhook['id']}/rotate-secret", [] );
		$this->assertStatus( 200, $response );
	...
	public function test_rotate_secret_requires_auth(): void {
		wp_set_current_user( 0 );
		$response = $this->dispatch( 'POST', '/sd-ai-agent/v1/webhooks/1/rotate-secret', [] );
		$this->assertStatus( 401, $response );
	}
	...
	public function test_trigger_missing_webhook_id_returns_400(): void {
		wp_set_current_user( 0 );
		$response = $this->dispatch( 'POST', '/sd-ai-agent/v1/webhook/trigger', [
			'message' => 'Hello',
		] );
		$this->assertStatus( 400, $response );
	}
