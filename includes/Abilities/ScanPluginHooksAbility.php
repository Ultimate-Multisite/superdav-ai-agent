...
class ScanPluginHooksAbility extends AbstractAbility {
	...
	protected function label(): string {
		return __( 'Scan Plugin Hooks', 'sd-ai-agent' );
	}

	protected function description(): string {
		return __( 'Scan an installed plugin for WordPress hooks (actions and filters) to enable extension-plugin generation.', 'sd-ai-agent' );
	}
