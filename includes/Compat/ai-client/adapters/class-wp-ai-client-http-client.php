 ...
 *
 * Provides PSR-18 HTTP Client adapter using WordPress HTTP API
 * on WordPress < 7.0 where this class is not available in core.
 *
 * On WordPress 7.0+, this file is a no-op — core's definition wins.
 *
 * Source: wp-includes/ai-client/adapters/class-wp-ai-client-http-client.php (WP 7.0)
 *
...
if ( class_exists( 'WP_AI_Client_HTTP_Client' ) ) {
	return;
}
