 ...
 *
 * Provides WordPress-specific PSR-14 event dispatcher for the AI Client
 * on WordPress < 7.0 where this class is not available in core.
 *
 * On WordPress 7.0+, this file is a no-op — core's definition wins.
 *
 * Source: wp-includes/ai-client/adapters/class-wp-ai-client-event-dispatcher.php (WP 7.0)
 *
